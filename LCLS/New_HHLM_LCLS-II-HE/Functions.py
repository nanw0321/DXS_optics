...
def define_HHLM_2DCM(
    ...
    im_after_HHLM2 = optics.PPM('im_after_HHLM2', FOV=5e-3,N=512,z=hhlm2.z+np.sign(hhlm3.z-hhlm2.z)*1e-3)
...
def define_HRM(E0, f1=10., f2=10., slit_width=3e-6,
    ...
    im_after_C1    = optics.PPM('im_after_C1',    z=crystal1.z+1e-3, FOV=5e-3, N=512)
    ...
    im_out         = optics.PPM('im_out',         z=crystal4.z+1e-3, FOV=5e-3, N=512)
